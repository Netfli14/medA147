  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {Icon && (
          <div className={cn(
            "mb-4 flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl transition-transform group-hover:scale-110",
            `bg-gradient-to-br ${gradient}`
          )}>
            <Icon className={cn("h-7 w-7 shrink-0 text-white", iconColor)} />
          </div>
        )}
