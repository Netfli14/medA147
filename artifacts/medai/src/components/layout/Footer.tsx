      ...
      <div className="container py-12">
        ...
        <div className="mt-10 pt-8 border-t border-primary/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <Link to="/privacy" className="text-xs text-muted-foreground hover:text-primary transition-colors duration-300">
              {t('privacyPolicy')}
            </Link>
            <span className="text-xs text-muted-foreground/40">·</span>
            <Link to="/terms" className="text-xs text-muted-foreground hover:text-primary transition-colors duration-300">
              {t('termsOfUse')}
            </Link>
          </div>
        </div>
